...
Sections as `comp.Tabs` with a count each, a table of pull requests, and a sidebar. CI's answer is a CHARACTER in the first column, so it survives the colour being stripped.
